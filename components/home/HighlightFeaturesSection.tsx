...
function HighlightFeatureSection(props) {
    return (
        <section className="text-white bg-gray-800">
            ...
            <div className="flex flex-row items-center justify-center bg-gradient-to-r from-blue-800 to-blue-400 py-4">
            ...
            <div className="flex flex-row items-center justify-center bg-gradient-to-r from-indigo-800 to-indigo-400 py-4">
            ...
            <div className="flex flex-row items-center justify-center bg-gradient-to-r from-sky-800 to-sky-400 py-4">
                <div className="order-1 flex flex-col max-w-[450px]">
