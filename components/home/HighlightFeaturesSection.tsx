...
function HighlightFeatureSection(props) {
    return (
        <section className="text-white bg-gray-800">
            ...
            <div className="flex flex-row items-center justify-center bg-[url('/images/bg-pattern-1.png')] py-4">
            ...
            <div className="flex flex-row items-center justify-center bg-[url('/images/bg-pattern-3.png')] py-4">
            ...
            <div className="flex flex-row items-center justify-center bg-black bg-[url('/images/bg-pattern-2.png')] py-4">
                <div className="order-1 flex flex-col max-w-[450px]">
