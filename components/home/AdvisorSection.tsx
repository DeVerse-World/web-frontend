...
function AdvisorSection() {
    ...
    return (
        <div className="mx-auto my-24 max-w-5xl px-6 sm:mt-5 lg:px-8 lg:mt-10">
            <div className="max-w-2xl lg:mx-0">     
                <h2 className="deverse-header text-3xl font-bold tracking-tight text-white sm:text-4xl ">Angels</h2>
            </div>
            <div
