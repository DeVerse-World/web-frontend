    ...
    <div>
      <div className="container">
        <div className="details row" style={{marginBottom: "2.5rem"}}>
          ...
          <h1 className="deverse-title-secondary">Smart NFTs</h1>
        ...
        <div className="details row" style={{textAlign: "right", marginBottom: "2.5rem"}}>
          ...
          <h1 className="deverse-title-secondary">Loot Boxes Reimagined</h1>
        ...
        <div className="details row">
          <div className="align-self-center col-md-7 col-12">
          <h1 className="deverse-title-secondary">Cross-Platform Items</h1>
            <p className="secondary-text">deverse wants gamers to be able to use the same in-game items between multiple video games.</p>
          </div>
          <div className="col align-self-center col-md-5 col-12">
